...
public class Sprite
{
    ...
    public Sprite(final Context activityContext)
    {
        ...
        int vertexShader = mRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = mRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
